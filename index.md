...
class Solution(object):
    def minSubarray(self, nums, p):
        ...
        if min_len < len(nums):
            ...
            return -1
```
- [ ] Напиши декоратор @retry_with_backoff(retries=3, delay=2).

- [ ] Він має пробувати виконати функцію. Якщо виникає Exception, він чекає delay секунд і пробує знову (максимум retries разів).

- [ ] Створи функцію unstable_api_call(), яка з ймовірністю 70% кидає помилку ValueError("Server Error").

- [ ] Задекоруй цю функцію і перевір, як вона "бореться" за успішний результат.
